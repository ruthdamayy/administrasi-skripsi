    ...
    <div id="main">
        ...
        <section class="section">
            ...
            @foreach ($tanggal as $dt)
                <div class="card">
                    <div class="card-body">
                        <h3>{{ Carbon::parse($dt->tanggal_sempro)->translatedFormat('l, d F Y') }}</h3>
                        <a href="/prodi/undangan_daftar_peserta/undangan_seminar_proposal/{{ $dt->tanggal_sempro }}"
                            target="blank"><button type="button" class="btn btn-success"><i
                                    class="bi bi-printer-fill"></i>&nbsp;Cetak Undangan</button></a>
                        &nbsp; &nbsp; &nbsp; &nbsp;
                        <a href="/prodi/undangan_daftar_peserta/peserta_seminar_proposal/{{ $dt->tanggal_sempro }}"
                            target="blank"><button type="button" class="btn btn-success"><i
