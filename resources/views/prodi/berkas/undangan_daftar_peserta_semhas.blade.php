...
<html>
<head>
	<title>Undangan & Daftar Peserta Seminar Hasil</title>
	<style type="text/css">
		table {
			border-style: solid;
			border-width: 3px;
	...
	<center>
		...
		<div class="batas">
			...
			<div>
				<table width="625">
					...
					<tr>
						...
						<td width="250">: Undangan Seminar Hasil Mahasiswa</td>
					</tr>			
				</table>
			</div>
			<br>
			...
			<div>
				<table width="625">
					<tr>
						<td class="text"><b>SEMINAR HASIL MAHASISWA</b></td>
					</tr>
					<tr>
			...
			<div>
				<table width="625">
					<tr>
						<td class="text4">Demi kelancaran kegiatan Seminar, kami harapkan kehadirannya agar tepat waktu. Untuk Daftar Penyaji Seminar dan Bahan Seminar terlampir.</td>
					</tr>
				</table><br>
			</div>
			<div>
		...
		<div>
			...
			<table width="1200" border="1" class="skrt">
				<tr>
					...
					<td width="100" class="text4"><font size="2"><b>PEMBANDING / PENGUJI</b></font></td>
