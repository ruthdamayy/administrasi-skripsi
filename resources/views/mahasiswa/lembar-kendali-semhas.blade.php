...
<html>
<head>
	<title>Lembar Kendali Seminar Hasil - Form 1B</title>
	<style type="text/css">
		body {
			width: 230mm;
			height: 100%;
			...
			<div>
				<center>
					...
					<table width="625">
						...
						<tr>
							<td class="text"><font size="3"><b>PRA SEMINAR HASIL</b></font></td>
						</tr>
					</table>
					</table><br>
					<table width="625">
						<tr>
							...
							<td width="100" class="skrtt"><b>FORM 1-B</b></td>
						</tr>
						<tr>
				...
				<center>
					...
					<div class="padsss">
						...
						<table width="625">
							<tr>
								<td width="30" ></td>
								<td width="70" class="skrrt" rowspan>Rencana Tanggal Seminar Hasill</td>
								<td width="120"></td>
								<td width="130">Medan, {{Carbon::parse($now)->translatedFormat('d F Y')}}</td>
							</tr>
							<tr>
								<td width="30"></td>
