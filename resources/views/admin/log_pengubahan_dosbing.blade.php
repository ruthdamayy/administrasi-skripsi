        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    ...
                    <p class="text-subtitle text-muted">Sama seperti pendaftaran, pengeditan dosbing juga hanya dilakukan
                        oleh admin!</p>
                </div>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($logs as $log)
                                            <tr>
                                                ...
                                                <td>
                                                    Admin {{ $log->nama_admin }} mengubah dosen pembimbing untuk mahasiswa
                                                    bernama <b>{{ $log->nama }}</b>, NIM <b>{{ $log->nim }}</b>,
                                                    menjadi seperti berikut berikut. <br>
                                                    NIP Dosbing 1 : {{ $log->old_nip_dosbing1 }} <b>menjadi</b>
                                                    {{ $log->new_nip_dosbing1 }}<br>
                                                    NIP Dosbing 2 : {{ $log->old_nip_dosbing2 }} <b>menjadi</b>
                                                    {{ $log->new_nip_dosbing2 }}<br>
                                                </td>
