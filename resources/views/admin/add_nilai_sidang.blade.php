                ...
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('nilai_sidang_admin') }}">Input Nilai Sidang
                                    Meja Hijau</a></li>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2 form-group">
                                                <input type="text" id="n17"
                                                    ...
                                                    name="n17" required autocomplete="n17">
                                                @error('n17')
                                                    <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2 form-group">
                                                <input type="text" id="n18"
                                                    ...
                                                    name="n18" required autocomplete="n18">
                                                @error('n18')
                                                    <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2 form-group">
                                                <input type="text" id="n19"
                                                    ...
                                                    name="n19" required autocomplete="n19">
                                                @error('n19')
                                                    <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2 form-group">
                                                <input type="text" id="n20"
                                                    ...
                                                    name="n20" required autocomplete="n20">
                                                @error('n20')
                                                    <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
