                    ...
                    <div class="row align-items-center m-5">
                        <div class="col-xl-12 mb-6">
                                                    ...
                                                    <td>
                                                        @if ($result->edited_by == 'mahasiswa')
                                                            <p>Mahasiswa bersangkutan ({{ $result->nama_pendaftar }} |
                                                                $result->nim) mengubah judul skripsi pada tanggal
                                                                {{ $result->created_at }}. Perubahan yang dilakukan sebagai
                                                                berikut.<br>
                                                                Judul : {{ $result->old_judul_skripsi }} <b>menjadi</b>
                                                                {{ $result->new_judul_skripsi }}
                                                            </p>
                                                        @else
                                                            <p>Admin {{ $result->nama_pengubah }} mengubah judul skripsi
                                                                mahasiswa dengan NIM {{ $result->nim }} pada tanggal
                                                                {{ $result->created_at }} untuk mahasiswa dengan NIM
                                                                <b>{{ $result->nim }}</b> sebagai berikut. <br>
                                                                Judul : {{ $result->old_judul_skripsi }} <b>menjadi</b>
                                                                {{ $result->new_judul_skripsi }}
                                                            </p>
                                                        @endif
                            ...
                            <div class="d-felx justify-content-center">
                                <a href="{{ route('log_pengubahan_skripsi') }}" class="btn btn-primary btn-sm"><i
