...
<html>
<head>
	<title>Form Persetujuan Seminar Hasil - Form 2D</title>
	<style type="text/css">
		body {
			width: 230mm;
			height: 100%;
				...
				<center>
					...
					<table width="625">
						<tr>
							...
							<td width="572">:  {{Carbon::parse($query[0]->tanggal_semhas)->translatedFormat('l / d F Y')}}</td>
						</tr>
						<tr>
							<td>Pukul</td>
					...
					<table width="625">
						<tr>
							<td style="padding-right: 70px;">Nama</td>
							<td width="572">:  {{$qr->nama_dosen}}</td>
							<td width="572"> {{$i}}</td>
						</tr>
						<tr>
							<td style="padding-right: 70px;">NIP</td>
							<td width="572">:  {{$qr->nip}}</td>
						</tr>
					</table><br>
					<?php $i++ ?>
					@endforeach
