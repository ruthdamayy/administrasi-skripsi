...
@section('title')
    <title>Dosen - Bimbingan Sidang</title>
@endsection
...
@section('content')
            ...
            <div class="row">
                <div class="col-md-12 col-md-6 order-md-1 order-last">
                    ...
                    <p class="text-subtitle text-muted text-right">Dosen dapat mengisikan kendali bimbingan skripsi
                        mahasiswa sebelum melakukan sidang meja hijau</p>
                </div>
    ...
    <section class="section">
        <div class="card">
            <div class="card-body">
                {{-- alert success_bimbingan_sidang --}}
                @if (session('success_bimbingan_sidang'))
                    <div class="alert alert-success alert-dismissible fade show" role="alert">
                        {{ session('success_bimbingan_sidang') }}
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                @endif
                {{-- alert error_bimbingan_sidang --}}
                @if (session('error_bimbingan_sidang'))
                    <div class="alert alert-danger alert-dismissible fade show" role="alert">
                        {{ session('error_bimbingan_sidang') }}
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                @endif
