...
@section('title')
    <title>Dosen - Bimbingan Seminar Hasil</title>
@endsection
...
@section('content')
    ...
    <section class="section">
        <div class="card">
            <div class="card-body">
                {{-- alert success_bimbingan_semhas --}}
                @if (session('success_bimbingan_semhas'))
                    <div class="alert alert-success alert-dismissible fade show" role="alert">
                        {{ session('success_bimbingan_semhas') }}
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                @endif
                {{-- alert error_bimbingan_semhas --}}
                @if (session('error_bimbingan_semhas'))
                    <div class="alert alert-danger alert-dismissible fade show" role="alert">
                        {{ session('error_bimbingan_semhas') }}
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                @endif
                <form method="POST" action="{{ route('simpan_bimbingan_semhas') }}">
                    @csrf
