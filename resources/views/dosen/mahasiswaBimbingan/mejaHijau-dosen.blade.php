                    ...
                    <table class="table" id="table1">
                        <thead>
                            <tr>
                                ...
                                <th>
                                    <font size="2">Persetujuan Sidang</font>
                                </th>
                                <th>
                                    <font size="2">Kata Pengantar Sidang</font>
                                </th>
                                <th>
                        ...
                        <tbody>
                            @foreach ($mahasiswa as $mhs)
                                <tr>
                                    ...
                                    <td>
                                        <a href="/dosen/berkasSemhas3/{{ $mhs->nim }}"><button
                                                class="btn btn-primary btn-sm"><i
                                                    class="bi bi-printer-fill"></i>&nbsp;Cetak</button></a>
                                    </td>
                                    <td>
                                        <a href="/dosen/berkasSemhas4/{{ $mhs->nim }}"><button
                                                class="btn btn-primary btn-sm"><i
                                                    class="bi bi-printer-fill"></i>&nbsp;Cetak</button></a>
                                    </td>
                                    <td>
                                        <a href="/dosen/berkasSemhas5/{{ $mhs->nim }}"><button
                                                class="btn btn-primary btn-sm"><i
                                                    class="bi bi-printer-fill"></i>&nbsp;Cetak</button></a>
                                    </td>
                                    <td>
